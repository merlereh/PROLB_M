...
public:
  ...
  : Node("kf_node")
  {
    ...
    initialpose_subscription_ =
      this->create_subscription<geometry_msgs::msg::PoseWithCovarianceStamped>(
        ...
        [this](geometry_msgs::msg::PoseWithCovarianceStamped::UniquePtr msg) {
          ...
          // Reset odom reference to current odom values
          odom_initialized_ = false;
          initialized_       = true;

          RCLCPP_INFO(this->get_logger(),
            "kf_node initialized from /initialpose (map frame): "
    ...
    odom_subscription_ =
      this->create_subscription<nav_msgs::msg::Odometry>(
        ...
        [this](nav_msgs::msg::Odometry::UniquePtr msg) {
          ...
          // First odom after init: store as reference, don't update filter
          ...
          // Compute odom delta in odom frame
          ...
          // Use predicted state as base, add odom delta rotated into map frame
          ...
          // Build absolute measurement in map frame from filter state + delta
    ...
    // /scan subscriber — landmark correction in map frame
    scan_subscription_ =
    ...
    RCLCPP_INFO(this->get_logger(),
      "kf_node started. Waiting for /initialpose. Landmark at (%.2f, %.2f)",
      LANDMARK_X, LANDMARK_Y);
  }
